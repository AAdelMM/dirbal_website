  ...
  <div class="SubSection w-full 2xl:h-[21.25rem] h-[12rem] left-0 2xl:top-[38rem] lg:top-[25rem] top-[35rem] flex justify-center absolute bg-gray-700/opacity-20 border-t-2 border-orange-400">
    <div class="Frame34 w-[86.15vw]   absolute justify-center items-center 2xl:gap-[11rem] lg:gap-[8rem] gap-[4rem] inline-flex">
      ...
      <div class="Frame258   flex-col justify-center items-center inline-flex pt-[2rem] 2xl:pt-[4rem]">
        ...
        <img class="Evidence 2xl:w-[7rem] 2xl:h-[7rem] lg:w-[6rem] lg:h-[6rem] w-[4rem] h-[4rem] " src="{{asset('images/ktab.png')}}" />
        </div>
        <div class=" text-[#161D27] lg:text-[2rem] text-[1.5rem] font-bold text-center " style="font-family:'Noto Kufi Arabic">كتاب</div>
      ...
      <div class="Group54 w-[7.3vw] lg:h-[8.75rem] h-[6rem] flex justify-center">
        <img class="Evidence 2xl:w-[7rem] 2xl:h-[7rem] lg:w-[6rem] lg:h-[6rem] w-[4rem] h-[4rem]  " src="{{asset('images/mabahth.png')}}" />
        </div>
        <div class="text-[#161D27] lg:text-[2rem]  text-[1.5rem] font-bold text-center " style="font-family:'Noto Kufi Arabic">مباحث</div>
      </div>
      <img src="{{asset('images/Vline.png')}}" alt="">
      ...
      <div class="Frame259  flex-col justify-center items-center inline-flex pt-[2rem] 2xl:pt-[4rem]">
        <div class="Group63 w-[7.3vw] lg:h-[8.75rem] h-[6rem] flex justify-center">
          <img class="Evidence 2xl:w-[7rem] 2xl:h-[7rem] lg:w-[6rem] lg:h-[6rem] w-[4rem] h-[4rem]  " src="{{asset('images/islamiat.png')}}" />
        </div>
        <div class=" text-[#161D27] lg:text-[2rem] text-[1.5rem] font-bold  text-center" style="font-family:'Noto Kufi Arabic">إسلاميات</div>
      </div>
    </div>
  </div>
