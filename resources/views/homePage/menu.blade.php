<div class="container-fluid main-menu flex justify-end w-full  h-auto absolute z-[500]">
  ...
  <div class="Group41 2xl:w-[6.4rem] 2xl:h-[9.6rem] lg:w-[5rem] lg:h-[7rem] lg:left-[2.2rem] w-[2.56rem] h-[3.8rem] left-[1.2rem] top-[2rem] absolute">
    <img class="CivDMp3Image684x10243 2xl:w-[6.4rem] 2xl:h-[9.6rem] lg:w-[4rem] lg:h-[5rem] w-[2.56rem] h-[3.8rem] left-0 top-0 absolute" src="{{ asset('images/menu-logo.png') }}" />
    
  </div>
  <img class="menu-ayah 2xl:w-[34.4rem] lg:w-[24rem] lg:h-[18.2rem] w-[13.8rem] 2xl:h-[26.3rem] h-[10.5rem] 2xl:left-[2.4rem] left-[1rem] 2xl:top-[31.5rem]  top-[20rem] absolute" src="{{ asset('images/menu-ayah.png') }}" />
