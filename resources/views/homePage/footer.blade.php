<!--start of section 4-->
      ...
      <div  id="foter"
      class=" w-full relative 2xl:h-[44.25rem] lg:h-[44.25rem] bg-black box-border overflow-hidden flex flex-row items-start justify-start py-[1.625rem] pr-[3.375rem] pl-[6.75rem] gap-[1.375rem] leading-[normal] tracking-[normal] text-right text-[1.875rem] text-white font-['Noto Kufi Arabic'] border-t-4 border-[#a6743e] mq850:pl-[1.688rem] mq850:box-border mq1225:pl-[3.375rem] mq1225:pr-[1.688rem] mq1225:box-border mq1550:flex-wrap">
      <footer 
        ...
        >
          ...
          <div class="w-[35vw] h-[7.5rem] inline-flex justify-end items-center my-[1rem]">
            ...
            <div class="self-stretch flex flex-col items-end justify-start">
              ...
              >
                <span>
                  <p class="m-0 lg:text-[0.7rem] 2xl:text-[0.9rem] " style="font-family:'Noto Kufi Arabic'; direction:rtl;">
                  بسم الله والحمد لله والصلاة والسلام على رسول الله.
وبعد، فمنذ الصبا واهتمامات شتّى تتجاذبني. لم يخلُ معظمها من فائدة، لكنها متمايزة حتى لا رابط يجمعها إلا الشغف بالعمل. ورغم ما أصابني من ذلك من خير أشكر الله تعالى عليه، أدركت أن العرفان الحقيقي بفضله سبحانه يكون بالإفاضة منه على الغير مصداقاً لأمره جلّ وعلا: "وَأَحْسِن كَمَا أَحْسَنَ اللَّهُ إِلَيْكَ". فطنت إذ ذاك إلى أن كثيراً من أنفاس زماني كانت في الحقيقة قد غادرت فارغة. فالتّشتت استنفد وسعي ووقتي، ولم يحظ جانب بالوافر اللازم ليتمخّض عمّا يصلح بذله، إذ لم يتعدّ جلُّ ما نتج فتاتاً في هذا المجال وفي ذاك.
الحمد لله الذي بنعمته تتم الصالحات. هُديتُ فانصرفت عن كثير لأستفرغ الوقت والجهد للأهم. فكان منه ما أينع وحان قطافه، فوجدّت أن من الخير أن أبدأ بنشره على هذه الشبكة. وإني بهذا لا أبتغي غير وجه الله، ولا أطمع ممّن يجد فائدة إلا في دعاء بالأجر والثواب وبالتوفيق والسداد. وإن هذا عندي لجدُّ عظيم. 
